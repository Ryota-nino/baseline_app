...
export {DetailContents, CompanyDetail, InsertUsers} from './CompanyDetail/index';
export {Register,RegisterInsert,RegisterSend,RegisterComplete} from './Register/index';
